...
public class CONOperationsImplementation implements CONOperations {
    ...
    public CONOperationsImplementation() throws IOException {
        logr = Logger.getLogger(this.getClass().getSimpleName());
        fh = new FileHandler("d:/logs/server_logs/Concordia.log", true);
    ...
    public int addItem(String managerID, String itemID, String itemName, int quantity) {
        if (Data.managerIDs.containsKey(managerID)) {
            try {
                ...
                System.out.println(managerID + " " + itemID + " " + itemName + " " + quantity);
                Thread.sleep(5000);
    ...
    public int removeItem(String managerID, String itemID, int quantity) {
        if (Data.managerIDs.containsKey(managerID)) {
            try {
                synchronized (this) {
                    String s = Data.bookInformation.get(itemID);
                    if (s == null) {
...
//                            return 1;
                    ...
                    case Communication.MCGPORT: {
                        ...
                        try {
                            Concordia.sendMessage(msg, Communication.MCGPORT);
                            logr.info("Request : Concordia Server -> Mcgill Server :Borrow Item request " + "Packet:" + "[" + msg + "]");
                        } catch (SocketException ex) {
                            Logger.getLogger(CONOperationsImplementation.class.getName()).log(Level.SEVERE, null, ex);
                        ...
                        while (loop) {
                            if (Communication.responseMessages.get(messageID) != null) {
                                ...
                                if (result3) {
                                    logr.info("Provider : McGill" + " " + "Borrow Item" + " " + userID + " " + itemID + " " + numberOfDays + " " + "Success" + "Return value:" + 1);
                                    return 1;
                    ...
                    case Communication.MONPORT: {
                        ...
                        String msg = "" + messageID + "," + raw_msg;
                        try {
                            Concordia.sendMessage(msg, Communication.MONPORT);
                            logr.info("Request:Concordia Server->Montreal Server :Borrow Item request " + "Packet:" + "[" + msg + "]");
                        } catch (SocketException ex) {
                            Logger.getLogger(CONOperationsImplementation.class.getName()).log(Level.SEVERE, null, ex);
                        } catch (IOException ex) {
                            Logger.getLogger(CONOperationsImplementation.class.getName()).log(Level.SEVERE, null, ex);
                        ...
                        while (loop) {
                            if (Communication.responseMessages.get(messageID) != null) {
                                ...
                                if (result3) {
                                    logr.info("Provider Montreal:" + " " + "Borrow Item" + " " + userID + " " + itemID + " " + numberOfDays + " " + "Success" + "Return value:" + 1);
                                    return 1;
                                } else if (!result1 && result2 && additionalchecker) {
                                    logr.info("Borrow Item" + " " + userID + " " + itemID + " " + numberOfDays + " " + "Fail" + "Return value:" + 2 + "Item not available.Could be granted Waitlist!");
                                    return 2;
                ...
                switch (destPort) {
                    ...
                    case Communication.MCGPORT: {
                        ...
                        try {
                            Concordia.sendMessage(msg, Communication.MCGPORT);
                            logr.info("Request:Concordia Server->MCGILL Server :Add into Waitlist request " + "Packet:" + "[" + msg + "]");
                        } catch (SocketException ex) {
                            Logger.getLogger(CONOperationsImplementation.class.getName()).log(Level.SEVERE, null, ex);
                        } catch (IOException ex) {
                            Logger.getLogger(CONOperationsImplementation.class.getName()).log(Level.SEVERE, null, ex);
                    ...
                    case Communication.MONPORT: {
                        ...
                        try {
                            Concordia.sendMessage(msg, Communication.MONPORT);
                            logr.info("Request:Concordia Server->Montreal Server :Add into Waitlist request " + "Packet:" + "[" + msg + "]");
                        } catch (SocketException ex) {
                            Logger.getLogger(CONOperationsImplementation.class.getName()).log(Level.SEVERE, null, ex);
                        } catch (IOException ex) {
                            Logger.getLogger(CONOperationsImplementation.class.getName()).log(Level.SEVERE, null, ex);
                        ...
                        while (loop) {
                            if (Communication.responseMessages.get(messageID) != null) {
                                ...
                                Communication.responseMessages.remove(messageID);
                                if (Boolean.parseBoolean(result)) {
                                    logr.info("MONTREAL Response : Add wait " + userID + " " + itemID + " " + "Success " + "Return value: 3");
                                    return 3;
                                } else {
                                    logr.info("MCGILL Response : Add wait " + userID + " " + itemID + " " + "Fail " + "Return value: 5");
                                    return 5;
    ...
    void removeFromWaitListAndBorrow(String itemID) {
        ...
        if (q.size() == 0) {
            Data.waitList.remove(itemID);
            if (userID.substring(0, 3).equals("MCG") || userID.substring(0, 3).equals("MON")) {
    ...
    public String findItem(String userID, String itemName) {
        if (Data.userIDs.containsKey(userID)) {
            ...
            try {
                ...
                String msg = "" + messageID + "," + raw_msg;
                Concordia.sendMessage(msg, Communication.MCGPORT);
                logr.info("Request:Concordia Server->MCGILL Server :Find Item request " + "Packet:" + "[" + msg + "]");
            } catch (SocketException ex) {
                Logger.getLogger(CONOperationsImplementation.class.getName()).log(Level.SEVERE, null, ex);
            } catch (IOException ex) {
                Logger.getLogger(CONOperationsImplementation.class.getName()).log(Level.SEVERE, null, ex);
            ...
            try {
                ...
                Concordia.sendMessage(msg, Communication.MONPORT);
                logr.info("Request:Concordia Server->MONTREAL Server :Find Item request " + "Packet:" + "[" + msg + "]");
            } catch (SocketException ex) {
                Logger.getLogger(CONOperationsImplementation.class.getName()).log(Level.SEVERE, null, ex);
            } catch (IOException ex) {
                Logger.getLogger(CONOperationsImplementation.class.getName()).log(Level.SEVERE, null, ex);
            ...
            while (loop1 || loop2) {
                ...
                if (Communication.responseMessages.get(messageID2) != null) {
                    ...
                    loop2 = false;
                    logr.info("MONTREAL Response : Find item " + userID + " " + itemName + " " + "Success " + result);
        ...
        if (Data.userIDs.containsKey(userID)) {
            ...
            switch (destPort) {
                ...
                case Communication.MCGPORT: {
                    ...
                    try {
                        Concordia.sendMessage(msg, Communication.MCGPORT);
                        logr.info("Request:Concordia Server->MCGILL Server :Return Item request " + "Packet:" + "[" + msg + "]");
                    } catch (SocketException ex) {
                        Logger.getLogger(CONOperationsImplementation.class.getName()).log(Level.SEVERE, null, ex);
                    } catch (IOException ex) {
                        Logger.getLogger(CONOperationsImplementation.class.getName()).log(Level.SEVERE, null, ex);
                ...
                case Communication.MONPORT: {
                    ...
                    try {
                        Concordia.sendMessage(msg, Communication.MONPORT);
                        logr.info("Request:Concordia Server->MONTREAL Server :Return Item request " + "Packet:" + "[" + msg + "]");
                    ...
                    while (loop) {
                        if (Communication.responseMessages.get(messageID) != null) {
                            ...
                            Boolean b = Boolean.parseBoolean(response);
                            if (b) {
                                logr.info("Montreal Response : Return item " + userID + " " + itemID + " " + "Success ");
                                return 1;
                            } else {
                                logr.info("Montreal Response : Return item " + userID + " " + itemID + " " + "fail");
                                return 2;
                            }
                        }
                    }
    ...
    boolean returnItemLocal(String userID, String itemID) {
        synchronized (this) {
            ...
            if (lbd == null || !(lbd.contains(itemID))) {
                ...
                System.out.println("After return and checking wait list");
                printDatabase1();
