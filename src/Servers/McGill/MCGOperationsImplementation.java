...
public class MCGOperationsImplementation implements MCGOperations {
    ...
    public MCGOperationsImplementation() throws IOException {
        logr = Logger.getLogger(this.getClass().getSimpleName());
        fh = new FileHandler("d:/logs/server_logs/McGill.log", true);
            ...
            if (waitWish == 0) {
                ...
                switch (destPort) {
                    ...
                    case Communication.CONPORT: {
                        ...
                        try {
                            ...
                            logr.info("Request : McGill Server -> Concordia Server :Borrow Item request " + "Packet:" + "[" + msg + "]");
                    ...
                    case Communication.MONPORT: {
                        ...
                        try {
                            ...
                            logr.info("Request:McGill Server->Montreal Server :Borrow Item request " + "Packet:" + "[" + msg + "]");
                        } catch (IOException ex) {
                            Logger.getLogger(MCGOperationsImplementation.class.getName()).log(Level.SEVERE, null, ex);
                        }
                        boolean loop = true;
                ...
                switch (destPort) {
                    ...
                    case Communication.CONPORT: {
                        ...
                        try {
                            McGill.sendMessage(msg, Communication.CONPORT);
                            logr.info("Request:McGill Server->Concordia Server :Add into Waitlist request " + "Packet:" + "[" + msg + "]");
                        } catch (IOException ex) {
                            Logger.getLogger(MCGOperationsImplementation.class.getName()).log(Level.SEVERE, null, ex);
                        }
                        boolean loop = true;
                    ...
                    case Communication.MONPORT: {
                        ...
                        try {
                            McGill.sendMessage(msg, Communication.MONPORT);
                            logr.info("Request:McGill Server->Montreal Server :Add into Waitlist request " + "Packet:" + "[" + msg + "]");
                        } catch (IOException ex) {
                            Logger.getLogger(MCGOperationsImplementation.class.getName()).log(Level.SEVERE, null, ex);
                        }
                        boolean loop = true;
                        while (loop) {
                            if (Communication.responseMessages.get(messageID) != null) {
                                ...
                                if (Boolean.parseBoolean(result)) {
                                    ...
                                    logr.info("Montreal Response : Add wait " + userID + " " + itemID + " " + "Fail " + "Return value: 5");
                                    return 5;
                                }
                            }
                        }
    ...
    void removeFromWaitListAndBorrow(String itemID) {
        ...
        if (q.size() == 0) {
            Data.waitList.remove(itemID);
            if (userID.substring(0, 3).equals("CON") || userID.substring(0, 3).equals("MON")) {
    ...
    public String findItem(String userID, String itemName) {
        if (Data.userIDs.containsKey(userID)) {
            ...
            try {
                ...
                String msg = "" + messageID + "," + raw_msg;
                McGill.sendMessage(msg, Communication.CONPORT);
                logr.info("Request:McGill Server->Concordia Server :Find Item request " + "Packet:" + "[" + msg + "]");
            } catch (IOException ex) {
                Logger.getLogger(MCGOperationsImplementation.class.getName()).log(Level.SEVERE, null, ex);
            }
            try {
                ...
                McGill.sendMessage(msg, Communication.MONPORT);
                logr.info("Request:McGill Server->Montreal Server :Find Item request " + "Packet:" + "[" + msg + "]");
            } catch (IOException ex) {
                Logger.getLogger(MCGOperationsImplementation.class.getName()).log(Level.SEVERE, null, ex);
            }
        ...
        if (Data.userIDs.containsKey(userID)) {
            ...
            switch (destPort) {
                ...
                case Communication.CONPORT: {
                    ...
                    try {
                        McGill.sendMessage(msg, Communication.CONPORT);
                        logr.info("Request:McGill Server->Concordia Server :Return Item request " + "Packet:" + "[" + msg + "]");
                    } catch (IOException ex) {
                        Logger.getLogger(MCGOperationsImplementation.class.getName()).log(Level.SEVERE, null, ex);
                    }
                    boolean loop = true;
                ...
                case Communication.MONPORT: {
                    ...
                    try {
                        McGill.sendMessage(msg, Communication.MONPORT);
                        logr.info("Request:McGill Server->Montreal Server :Return Item request " + "Packet:" + "[" + msg + "]");
                    } catch (IOException ex) {
                        Logger.getLogger(MCGOperationsImplementation.class.getName()).log(Level.SEVERE, null, ex);
                    }
                    boolean loop = true;
